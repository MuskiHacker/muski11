...
\n\x1b[1;91m╚═╝░░░░░╚═╝░╚═════╝░╚═════╝░╚═╝░░╚═╝╚═           
\n\x1b[1;91m-----------------------------------------------
\n\x1b[1;97m Author.     :   XTYLISH PATHANI
\n\x1b[1;97m Facebook :   xtylish.pathani.2021
\n\x1b[1;97m Queen.      :  TFG OWNER
\n\x1b[1;91m-----------------------------------------------'
...
def reg():
    ...
    r = requests.get('https://raw.githubusercontent.com/muskanpathani/muski11/main/server.txt').text
    if to in r:
...
def c_s():
    ...
    cps = []
    oks = []
    a_s = raw_input(' \x1b[1;97m\xe2\x95\xb0\xe2\x94\x80Pathani\xe2\x9e\xa4 ')
    if a_s == '1':
        os.system('clear')
        print logo
